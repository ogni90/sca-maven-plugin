...
public class CouplingMultiGraphGenerator {
    ...
    public DirectedMultigraph<String,LabeledEdge> getGraph() throws IOException {
        ...
        for (File classFile : classFiles) {
            ...
            if (myClassNode.superName != null && !myClassNode.superName.equals("java/lang/Object")) {
            ...
            for (MethodNode method : myClassNode.methods) {
                ...
                for (AbstractInsnNode ain : method.instructions.toArray()) {
                    if (ain.getType() == AbstractInsnNode.METHOD_INSN) {
                        ...
                        if (methCall.owner != myClassNode.name && !methCall.owner.startsWith("java/")) {
                            /*
                            myLog.debug(
                                    "Found call from "
                                            + method.name
                    ...
                    if (ain.getType() == AbstractInsnNode.FIELD_INSN) {
                        ...
                        if (fieldInsnNode.owner != myClassNode.name
                ...
                for (Type parameterType : parameterTypes) {
                    //myLog.debug(
                    //        "Paramter internalName: " + cleanInternalName(parameterType.getInternalName()));

                    if (!cleanInternalName(parameterType.getInternalName()).startsWith("java/")) {
                        if (!couplingGraph
                                .vertexSet()
